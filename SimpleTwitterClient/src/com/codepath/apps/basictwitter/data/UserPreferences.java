...
public class UserPreferences {
	...
	public void updateUserData(User user) {
		...
		editor.putString("followers", user.getFollowers());
		editor.putString("following", user.getFollowing());
		editor.commit();
	}
	...
	public User getUserData() {
		...
		user.setTagline(userPrefs.getString("tagline", ""));
		user.setFollowers(userPrefs.getString("followers", ""));
		user.setFollowing(userPrefs.getString("following", ""));
		return user;
	}
}